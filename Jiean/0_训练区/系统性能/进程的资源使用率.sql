...
SELECT spid,kpid,cpu,physical_io,memusage,sql_handle,1 AS SAMPLE,GETDATE() AS sampleTime,hostname,program_name,nt_username 
INTO #Resources
...
INNER JOIN #Resources AS r2 ON r1.spid=r2.spid AND r1.kpid=r2.kpid
...
r1.program_name,r1.nt_username 
INTO #Usage
FROM #Resources AS r1 
INNER JOIN #Resources AS r2 ON r1.spid=r2.spid AND r1.kpid=r2.kpid 
WHERE r1.SAMPLE=1 AND r2.SAMPLE=2 AND (r2.cpu-r1.cpu) >0
